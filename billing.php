...
<hr color="#999999" />
  <div class="tab-content">
    ...
    <!-------- home panel ----------------------------->
      <h4>Hi Dear, <?php echo $sessionname; ?></4>
      <hr color="#000000" />
      ...
      <div class="col-md-4 ">
         <div class="panel panel-info">
            <div class="panel-heading">
              ...
              <a href="clients.php"><div class="panel-footer"><h4 align="center"></span>View</h4></div></a>
         </div>
      </div>
    </div>
   <!-----  Switch View para madidirect ka sa ibang page kahit nasa home page ka  -->
    <div class="col-md-4">
         <div class="panel panel-info">
            <div class="panel-heading">
              ...
              <a href="user.php"><div class="panel-footer"><h4 align="center"></span>View</h4></div></a>
         </div>
      </div>
    </div>
    ...
    <div class="col-md-4">
         <div class="panel panel-info">
            <div class="panel-heading">
                <div class="panel-title"><h5 style="font-size:24px; font-weight:bold;">Bills and Consumption</h5></div>
            </div>
              <div class="panel-body">
             ...
             <a href="bill.php"> <div class="panel-footer"><h4 align="center"></span>View</h4></div></a>
         </div>
      </div>
    </div>
   <!--------- Ending nato  ng Home Page ------>
