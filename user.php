...
<div class="container">
<div id="wrapper">
  <h1><center><b>User Portal</b></center></h1>
  ...
  <div class="tab-content">
    ...
    <!-------- Start User  panel ----------------------------->
         ...
         <div class="panel panel-info">
            ...
            <div class="panel-title"><h5>System Users</h5><a rel='facebox' href="adduser.php" ><button type="button" class="btn btn-primary btn-xs">Add User</button></a><a href="deleteuser.php"></button></button></a></div>
          </div>
...
// Taga hanap ng id sa  mga pinipindot mong link
